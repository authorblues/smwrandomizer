...
[
	...
	["STAR ", "HYPE ", "MOON ", "KUSO ", "EPIC ", "CHALLENGING "],
	"#1 IGGY'S ",
	"#2 MORTON'S ",
	"#3 LEMMY'S ",
	"#4 LUDWIG'S ",
	...
	"#6 WENDY'S ",
	"#7 LARRY'S ",
	["DONUT ", "PIZZA ", "KUSO! ", "KOOPA ", "KAIZO ", "SUSHI ", "AMOGUS "],
	"GREEN ",
	["TOP SECRET AREA ", "TAKE A BREAK ", "WHY THE RUSH? ", "KEEP YOUR CAPES ", "MMMM GOOD SHIT ", "SNEAKY "],
	["VANILLA ", "DIAMOND ", "CALZONE ", "EMERALD "],
	"\uE038\uE039\uE03A\uE03B\uE03C ", // YELLOW
	"RED ",
	"BLUE ",
	["BUTTER BRIDGE ", "CHEESE BRIDGE ", "APPLE ISTHMUS ", "ASIAGO CHEESE ", "OCTOGON "],
	["CHEESE BRIDGE ", "BUTTER BRIDGE ", "PASTA PLATEAU ", "BOUNCING SAWS "],
	["SODA LAKE ", "POP OCEAN ", "INK SWAMP ", "SELTZER SEA "],
	...
	["SUNKEN GHOST SHIP ", "GHOSTS OF YOSHI ", "SMB3 AIRSHIP ", "STREAMBIG.NET ", "PIRACY BOAT "],
	["VALLEY ", "SUMMIT ", "RIVERS ", "THREAT ", "WOUNDS ", "GALAXY "],
	["BACK DOOR ", "NO ENTRY ", "GO AWAY ", "LEAVE NOW ", "NO EXISTING ZONE "],
	["FRONT DOOR ", "GET READY ", "FINAL BOSS "],
	["GNARLY ", "WACKY ", "CRAZY ", "KOOKY ", "NUTTY ", "STUPID ", "KINKY "],
	["TUBULAR ", "(-.-) ", "YATTA! "],
	["WAY COOL ", "GLORIOUS ", "STYLISH ", "SUAVE "],
	["HOUSE ", "ABODE ", "CONDO ", "TOWER ", "BUNGALOW "],
	["ISLAND ", "MIRAGE ", "TUNNEL ", "CAVERN ", "BRIDGE ", "GALAXY "],
	"SWITCH PALACE ",
	["CASTLE ", "TEMPLE ", "DOMAIN ", "CHUNK "],
	["PLAINS ", "TUNDRA ", "MEADOW ", "CAVERN ", "BRIDGE "],
	["GHOST HOUSE ", "BOO'S HAUNT ", "GRAVEYARD "],
	["SECRET ", "TEMPLE "],
	["DOME ", "ZONE ", "CAVE ", "SPHERE "],
	["FORTRESS ", "DUNGEON ", "DUNGEONS ", "PANTHEON ", "CAPITAL ", "CENTRE ", "CENTER ", "MIDPOINT "],
	...
	["AREA", "ZONE", "SPOT", "HILL", "SPHERE"],
	["GROOVY", "CRAZY", "DEATH!"],
	["MONDO", "Kappa", "GG!", "????", "OMG!"],
	["OUTRAGEOUS", "UNNATURAL", "MENTAL", "MADNESS", "TRY NOCAPE", "BibleThump", "FABULOUS", "OTHERWORLDLY",],
